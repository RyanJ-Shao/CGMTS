...
prepro(inputdir=paste(datadir, "/DexcomG6/", sep = ""), outputdir, outlierdet = TRUE, interval = 5, imputation = TRUE, immethod = "linear", maxgap = 60, compeleteday = TRUE, removeday = FALSE, device = 3, transunits = TRUE, removeflday = TRUE)
```
